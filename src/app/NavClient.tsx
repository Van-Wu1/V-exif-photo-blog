          ...
          <AnimateItems
            ...
            items={showNav
              ? [<nav
                ...
                {/* Mobile: First Row - Back Button + Title */}
                <div className={clsx(
                ...
                {/* Mobile: Second Row - View Switcher + Search + Theme Switcher */}
                <div className={clsx(
                  'flex items-center md:hidden',
                  'w-full',
                  'mt-2',
                )}>
                  {/* View Switcher (without search) */}
                  <AppViewSwitcher
                  ...
                  />
                  {/* Divider */}
                  <div className="h-[10px] w-[1px] bg-gray-400 dark:bg-gray-600 mx-2" />
                  {/* Search Button */}
